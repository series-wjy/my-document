...
public class ForeachDemo {
    ...
    public static void stream() {
        System.out.println("======================feature8.stream feature8.foreach======================");
    ...
    public static void useList() {
        System.out.println("======================useList feature8.foreach======================");
        ArrayList<Integer> numberList = new ArrayList<>(Arrays.asList(1,2,3,4,5));
        Consumer<Integer> action = System.out::println;
    ...
    public static void useMap() {
        System.out.println("======================useMap feature8.foreach======================");
    ...
    public static void customAction() {
        System.out.println("======================custome action feature8.foreach======================");
        HashMap<String, Integer> map = new HashMap<>();
        map.put("A", 1);
        map.put("B", 2);
        map.put("C", 3);
