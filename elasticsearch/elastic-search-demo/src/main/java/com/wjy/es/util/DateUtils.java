...
public class DateUtils {
	...
	public static String DATETIME_FORMAT_DETAIL = "yyyyMMddHHmmssSSS";
	 ...
	 * 毫秒string取前十位
	 */
	public static String msStr10(){
		return new String(String.valueOf(System.currentTimeMillis()).substring(0,10));
	}
	 ...
	 * hour 小时之后
	 */
	public static Date afterForHour(int hour){
		return new Date(System.currentTimeMillis() + hour * 3600000L );
	}
	/**
	 * 
	 * @param minute
	 ...
	 * minute 分钟之后
	 */
	public static Date afterForMin(int minute){
		return new Date(System.currentTimeMillis() + minute * 60000L);
	}
	/**
	 * 
	 * @param second
	 ...
	 * second 秒之后
	 */
	public static Date afterForSecond(int second){
	...
	public static String formatDateTimeSS(Date d) {
		return new SimpleDateFormat(DEFAILT_DATE_TIME_PATTERN_MILLI).format(d);
	}
...
//			log.error(e.getLocalizedMessage());
	...
	public final static String DEFAILT_DATE_TIME_PATTERN_2 = "yyyy/MM/dd'T'HH:mm:ss";
	
	
	/** 日期时间 */
	public final static String DEFAILT_DATE_TIME_PATTERN_MILLI = "yyyy-MM-dd HH:mm:ss.SSS";
	/** 时间 */
...
//			log.error(e.getLocalizedMessage());
	 ...
	 * log.debug(getMaxDateTimeForToDay());
	 * log.debug(getMinDateTimeForToDay()); }
	 */
